...
| RMC | <1>UTC时间 | <2>定位状态 | <3>纬度 | <4>纬度半球N或S | <5>经度 | <6>经度半球E或W | <7>地面速率 | <8>地面航向 | <9>UTC日期 | <10>磁偏角 | <11>磁偏角方向E或W | <12>模式指示 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 是否强匹配 | 是 | 是 | 是 | 是 | 是 | 是 | 否 | 否 | 是 | 否 | 否 | 否 |
...
| GGA | <1>UTC时间 | <2>纬度 | <3>纬度半球N或S | <4>经度 | <5>经度半球E或W | <6>GPS状态 | <7>正在使用解算位置的卫星数量 | <8>HDOP水平精度因子 | <9>海拔高度 | <10>地球椭球面相对大地水准面的高度 | <11>差分时间 | <12>差分站ID号 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 是否强匹配 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 否 | 是 | 否 | 否 | 否 |
...
| VTG | <1>以真北为参考基准的地面航向 | <2>以磁北为参考基准的地面航向 | <3>地面速率 | <4>地面速率 | <5>模式指示 |
|---|---|---|---|---|---|
| 是否强匹配 | 否 | 否 | 是 | 是 | 是 |
...
| GSV | <1>GSV语句的总数 | <2>本句GSV的编号 | <3>可见卫星的总数 | <4>PRN码 | <5>卫星仰角 | <6>卫星方位角 | <7>信噪比 |
|---|---|---|---|---|---|---|---|
| 是否强匹配 | 是 | 是 | 是 | 否 | 否 | 否 | 否 |
